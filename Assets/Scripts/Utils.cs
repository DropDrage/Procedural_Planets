...
public static class Utils
{
    ...
    public static GameObject SpawnPrefab(string prefabName, Vector3 pos) => SpawnPrefab(LoadPrefab(prefabName), pos);
    ...
    /*public static void RotateAroundAxis(this Vector3 vector3)
    {
        vector3
    }*/
}