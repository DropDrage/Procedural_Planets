...
namespace Noise
{
    public class NoiseGenerator
    {
        ...
        void Randomize(int seed)
        {
            ...
            {
                for (int i = 0; i < RandomSize; i++) _random[i + RandomSize] = _random[i] = Source[i];
            }
        }

        static double Dot(int[] g, double x, double y, double z, double t) => g[0] * x + g[1] * y + g[2] * z + g[3] * t;

        static double Dot(int[] g, double x, double y, double z) => g[0] * x + g[1] * y + g[2] * z;

        static double Dot(int[] g, double x, double y) => g[0] * x + g[1] * y;
