...
{
    public class SunParametersGeneratorUniTask
        : BaseUniTaskPlanetGenerator<SunGenerationParameters, SunGeneratorUniTask>
    {
        ...
        protected override NoiseSettings GenerateNoiseSettings(Random random,
        ...
        // sync
        protected override void CustomGeneration(GameObject planet, Random random)
        {
