...
{
    public class SunGeneratorGPU : PlanetGeneratorGPU
    {
        private const float MinAudioDistanceModifier = 1.1f;
        private const float MaxAudioDistanceModifier = 15f;


        protected override TerrainFaceGeneratorGPU CreateTerrainFace(Mesh sharedMesh, Vector3 direction) =>
            new FlatTerrainFaceGeneratorGPU(shapeGenerator, sharedMesh, resolution, direction);
